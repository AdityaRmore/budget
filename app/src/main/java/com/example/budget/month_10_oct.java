...
public class month_10_oct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_10_oct);

        recyc=findViewById(R.id.oct_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("oct").child(favuser);//also called  CAR
