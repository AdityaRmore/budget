...
public class month_11_nov extends AppCompatActivity {
    RecyclerView recyc ;
    TextView month_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_11_nov);

        recyc=findViewById(R.id.nov_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("Nov").child(favuser);//also called  CAR
