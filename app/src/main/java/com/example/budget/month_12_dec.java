...
public class month_12_dec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_12_dec);

        recyc=findViewById(R.id.dec_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("December").child(favuser);//also called  CAR
