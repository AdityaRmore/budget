...
public class month_5_may extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_5_may);

        recyc=findViewById(R.id.may_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("May").child(favuser);//also called  CAR
