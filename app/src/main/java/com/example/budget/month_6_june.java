...
public class month_6_june extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_6_june);

        recyc=findViewById(R.id.june_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("June").child(favuser);//also called  CAR
