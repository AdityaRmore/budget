...
public class month_7_jully extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_7_jully);

        recyc=findViewById(R.id.jully_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("Jully").child(favuser);//also called  CAR
