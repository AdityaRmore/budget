...
public class month_8_aug extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.month_8_aug);

        recyc=findViewById(R.id.aug_recyc);
        ...
        dataRef= FirebaseDatabase.getInstance().getReference().child("August").child(favuser);//also called  CAR
